...
# magic guid is the databricks service resource
...
#terraform plan -var workspace_url="$workspace_url" -var access_connector_id="$access_connector_id" -var workspace_id="$workspace_id" -var auth_token="$aad_pat"
